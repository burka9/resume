...
('Ethiopian-Gregorian Date Converter', 'ethiopian-date-converter', 'Open-source TypeScript library for converting between Ethiopian and Gregorian calendars. Published on npm with built-in type declarations. Handles leap years in both calendars, uses 4-year term cycle conversion, and provides a simple API with GDate and EthDate classes. Used in production applications requiring Ethiopian calendar integration.', 'TypeScript, npm', 'https://github.com/burka9/ethiopian-gregorian-date-converter', 'https://www.npmjs.com/package/ethiopian-gregorian-date-converter', NULL),
('MySMS - SMS Gateway Service', 'mysms-gateway', 'Self-hosted SMS gateway service that provides an API for programmatic SMS sending using Android phones as SMS modems. Built with a RESTful API backend and Flutter Android app that connects via Socket.IO to send SMS messages. Features include message queue management, delivery status tracking, rate limiting, and authentication. Currently expanding to integrate with SMS providers including Twilio and Ethio Telecom SMS Centers. Used by personal network for reliable SMS delivery.', 'Node.js, TypeScript, Express, Socket.IO, TypeORM, PostgreSQL, Flutter', NULL, 'https://sms.onecard.et/', NULL),
...
('Attendance, Warehouse and Finance Management System', 'attendance-warehouse-finance', 'A comprehensive system built for Muntaha Foundation that automates beneficiary registration, attendance tracking, warehouse inventory management, and donation/payment tracking.', 'Node.js, MySQL, React', NULL, NULL, NULL),
...
('Epic Trading', 'https://epictreading.com/', 'Global import-export firm specializing in sourcing, distributing, and trading high-quality goods across international markets.', '/images/portfolio/epic-trading.webp'),
